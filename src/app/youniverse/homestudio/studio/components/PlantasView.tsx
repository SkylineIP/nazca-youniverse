    ...
    return (
        <>
            ...
            <Image
                ...
                alt="plantas"
                className="object-contain como  col-span-10 row-span-14 col-start-6 row-start-6 translate-x-[380px] relative animate-fade-down animate-duration-[2000ms] duration-1000 z-10"
                width={1920}
                height={1080}
