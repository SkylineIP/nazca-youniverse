...
const ImplantacaoView = () => {
    ...
    const svgViewBoxes: { [key: string]: string } = {
        "1 hall social": "996 -100 400 970",
        "2 espaço gourmet": "488 -340 400 970",
        "3 fit studio": "680 -385 400 970",
        "4 repouso": "1125 -520 400 970",
        "5 piscina aquecida": "1310 -425 400 970",
        "6 sauna": "1025 -500 400 970",
        "7 ducha": "1000 -435 400 970",
        "8 sanitários": "1042 170 400 970",
        "9 reunião": "1200 -220 400 970",
        "10 coworking": "1390 -100 400 970",
        "11 lavanderia": "1420 70 400 970",
    };
    ...
    return (
        <>
            ...
            <div className="relative col-start-7 col-span-9 row-start-8 row-span-8">
                <Image
                    src={implantacao}
                    alt="Rooftop"
                    className={` object-contain animate-fade-up animate-duration-[2000ms] duration-1000 transition-transform ease-in-out 
                        ${menuSelected === "" ? "scale-[130%] translate-x-50 4k:scale-[130%] 4k:translate-x-140" : ""}`}
                    fill
                />
                {selectedMenuButton && (
                    <button
            ...
            <div className='row-start-18 col-start-10 col-span-11 row-span-4 grid grid-flow-col grid-rows-4 gap-x-4 gap-y-2'>
                {menuButtons.map((button, index) => (
                    ...
                    >
                        <span
                            className={`relative text-xl desktopmini:text-sm 4k:text-3xl uppercase font-aviano px-4 py-2 transition-colors duration-300 ease-in-out ${menuSelected === button.name
                                ? "bg-[#939598] text-white "
                                : "text-black"}`}
                        >
                            {button.name}
                        </span>
